...
The upshot of all this theory is that we can represent an unstructured mesh as a finite collection of matrices with integer entries.
These matrices are the representation of how one of the boundary operators acts in a certain choice of basis for the current spaces.
