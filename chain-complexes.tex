...
\begin{align}
    \partial_1'' & = \left[\begin{matrix}\partial_1 & I & I & \\ & -\mathbbm{1}^* & & I \\ & & -\mathbbm{1}^* & \mathbbm{1}^*\end{matrix}\right], \label{eq:double-cone-partial1} \\
...
If we take the original 2D filling faces to be a single triangle, then the previous equations give an alternative implementation of 2 $\leftrightarrow$ face flips.
